...
const TripHistoryPage: React.FC = () => {
    ...
    const { items, loading, error, currentPage, total, monthSpend, lifetimeSpend, thisMonthTrips } = useAppSelector((s) => s.trips);
    ...
    const hasMore = items.length === CONFIG.page_size && (currentPage * CONFIG.page_size) < total;
